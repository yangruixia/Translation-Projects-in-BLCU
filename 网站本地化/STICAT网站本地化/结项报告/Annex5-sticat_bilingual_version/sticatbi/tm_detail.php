      ...
      <section>
        ...
        <div class="row text-right">
         <div class="col-md-4 text-left">
           <a class="btn peach-gradient btn-rounded btn-sm" href="tm.php"><?php echo $lang["go_back"];?></a>
         </div>
            
            <div class="col-md-8 text-right">
              <div>
              <a type="button" class="btn btn-outline-info btn-rounded " href ="function_tm/export_test.php?id=<?php echo $tmid;?>"><?php echo $lang["export_excel"];?></a>
              <a type="button" class="btn btn-outline-success btn-rounded " href ="tm_detail_creation.php?id=<?php echo $tmid;?>"><?php echo $lang["add_tmpair"];?></a>
              </div> 
            </div>
          </div>
            ...
            $rowt = mysqli_fetch_array($resultt, MYSQLI_ASSOC); */
                  ...
                  <td>	
                  <a type='submit' class='btn-floating btn-danger btn-sm hvr-float-shadow' href ='function_tm/tm_detail_delete.php?id={$tmdid}'><i class='far fa-trash-alt'></button>							
