         ...
         <div class="col-md-8 text-left">
           <a class="btn peach-gradient btn-rounded btn-sm" href='file_join.php?id=<?php echo $_SESSION['project'];?>'><?php echo $lang["go_back"];?></a>
            ...
            <div class="col-md-4 text-right">
              ...
              <table id="dtbaterialDesignExample" class="table table-sm" cellspacing="0" width="100%">
                <thead>
                  <tr>
...
$(document).ready(function () {
  $('#dtbaterialDesignExample').DataTable();
  $('#dtbaterialDesignExample_wrapper').find('label').each(function () {
    $(this).parent().append($(this).children());
  });
  $('#dtbaterialDesignExample_wrapper .dataTables_filter').find('input').each(function () {
    const $this = $(this);
    $this.attr("placeholder", "<?php echo $lang["search"];?>");
    $this.removeClass('form-control-sm');
  });
  $('#dtbaterialDesignExample_wrapper .dataTables_length').addClass('d-flex flex-row');
  $('#dtbaterialDesignExample_wrapper .dataTables_filter').addClass('md-form');
  $('#dtbaterialDesignExample_wrapper select').removeClass(
  'custom-select custom-select-sm form-control form-control-sm');
  $('#dtbaterialDesignExample_wrapper select').addClass('mdb-select');
  $('#dtbaterialDesignExample_wrapper .mdb-select').materialSelect();
  $('#dtbaterialDesignExample_wrapper .dataTables_filter').find('label').remove();
});
