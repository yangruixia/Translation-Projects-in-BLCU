...
if($_GET)
{
  ...
  $search = $_GET["search"];
  //接收输入框数据
  $sql = "SELECT * FROM tb WHERE uid='$user_id' AND name LIKE '%{$search}%'";
...
<div class="row">
    ...
    <form  method="GET" action="">
        <div class="card-body row no-gutters align-items-center">
            ...
            <!--end of col-->
            <div class="col">
                <input class="form-control form-control-lg form-control-borderless" type="search" name="search" placeholder="<?php echo $lang["tb_search_default"];?>" value ="<?php echo $search?>">
            </div>
            <!--end of col-->
            <div class="col-auto">
...
<div class="card">
  ...
  <div class="card-body" >
    ...
    <hr>
    <!-- Quotation -->
    <p class="mb-0">'.$lang["descriptions"].$row["text"].'</p>
    <p class="mb-0">'.$lang["dates"].$row["date"].'</p>
    <br>
    <a type="button" class="btn btn-light-blue" href ="tb_show_card.php?id='.$tbid.'">'.$lang["view"].'</a>
    <a type="button" class="btn btn-cyan" href ="function_project_tb/add.php?id='.$tbid.'">'.$lang["add"].'</a>
