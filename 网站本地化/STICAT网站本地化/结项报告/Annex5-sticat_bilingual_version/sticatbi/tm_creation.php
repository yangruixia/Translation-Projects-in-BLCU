...
<form action="function_tm/create_tm.php" method="post" role="form">
<!-- Section: Inputs -->
<section class="section card mb-5 ">
  ...
  <div class="card-body text-left">
    ...
    <!-- Section heading -->
<br>
    <h5 class="pb-5"><?php echo $lang["create_new_tm"];?></h5>
    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="md-form">
          ...
          <label for="form1" class=""><?php echo $lang["tm_name"];?></label>
        </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <div class="md-form">
          ...
          <label for="form10"><?php echo $lang["tm_description"];?></label>
        </div>
